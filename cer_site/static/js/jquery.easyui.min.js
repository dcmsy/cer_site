 ...
 * 删除propertygrid、treegrid、calendar、datebox、datetimebox
 * 去除多表头，优化性能
 * 添加方法hideCheckbox（10972）、disabledCheckbox、tooltip
 */
(function($) {
	$.parser = {
		auto : true,
		...
		plugins : ["draggable", "droppable", "resizable", "pagination",
				...
				"timespinner", "slider", "layout", "panel", "datagrid", "tabs",
...
(function($) {
	function _6f(_70) {
		...
		var btnText = t.find(".l-btn-text");
		if (_71.text) {
			btnText.html(_71.text);
			if (_71.iconCls) {
//				t.find(".l-btn-text").addClass(_71.iconCls)
//						.addClass(_71.iconAlign == "left"
//								? "l-btn-icon-left"
//								: "l-btn-icon-right");
				btnText.before('<i class="icon iconfont">' + _71.iconCls + '</i>');
			}
		} else {
			t.find(".l-btn-text")
			...
			if (_71.iconCls) {
				...
				t.find(".l-btn-empty").append('<i class="icon iconfont">' + _71.iconCls + '</i>');
			}
		}
	...
	function _1ea(_1eb) {
		...
		if (opts.title && !opts.noheader) {
			...
			if (opts.iconCls) {
				...
				$("<div class=\"panel-icon\"></div>").append('<i class="icon iconfont">'+opts.iconCls+'</i>')
						.appendTo(_1ed);
			}
	...
	$.messager = {
		...
		confirm : function(_27a, msg, fn) {
			var _27b = "<div class=\"messager-icon messager-question\"></div>"
					+ "<div style='margin-top:6px;'>" + msg + "</div>" + "<div style=\"clear:both;\"/>";
			var _27c = {};
...
(function($) {
	...
	function _30a(_30b, _30c) {
		...
		if (opts.iconCls) {
			...
			_310.append('<i class="icon iconfont">'+opts.iconCls + '</i>');
		} else {
					...
					if (!item.hasClass("menu-sep")) {
						...
						if (_39f.iconCls) {
							$("<div class=\"menu-icon\"></div>")
									.append('<i class="icon iconfont">'+_39f.iconCls +'</i>').appendTo(item);
						}
						if (_39f.disabled) {
...
(function($) {
	...
	function load(_43b, data) {
		...
		function _441(name, val) {
			var form = $(_43b);
			var cc = ["combobox", "combotree", "combogrid", "combo"];
	...
	function _448(_449) {
		_449.reset();
		var t = $(_449);
		var _44a = ["combo", "combobox", "combotree", "combogrid", "spinner",
...
(function($) {
	...
	function _50b(_50c, _50d) {
		function _50e() {
			var _50f = [];
			var _510 = [];
			// 优化foreach为for，去除多个表头的加载
			var $thead = $(_50c).children("thead");
			var opt = $.parser.parseOptions($thead, [{
								frozen : "boolean"
							}]);
			...
			for (i = 0; i < $trs.length; i++) {
				...
				for (j = 0; j < $ths.length; j++) {
					var th = $($ths[j]);
					var col = $.extend({}, $.parser.parseOptions(th, ["field",
											"align", "halign", "order", {
												sortable : "boolean",
												checkbox : "boolean",
												resizable : "boolean",
	...
	function _52b(_52c) {
		...
		dc.body1.add(dc.body2).unbind().bind("mouseover", function(e) {
					...
					if (tt.parent().hasClass("datagrid-cell-check")) {
						...
						//复选框隐藏的禁止选择
						if(!tr.find(".datagrid-cell-check").children().length){
							return;
						}
	...
	function _5a0(_5a1, _5a2) {
		...
		opts.finder.getTr(_5a1, "", "allbody")
				.find("div.datagrid-cell-check input[type=checkbox]").closest("tr").addClass("datagrid-row-selected");
		if (opts.idField) {
	...
	function _598(_5ad, _5ae, _5af) {
		...
		if (ck[0]) {
			...
			var rk = tr.find("div.datagrid-cell-check input[type=radio]");
			rk._propAttr("checked", true);
		}
	...
	$.fn.datagrid.methods = {
		...
		/**
		 * 添加的方法，隐藏某一行的chckbox和某一列增加tooltips
		 */
		hideCheckbox : function(jq, index) {
			return jq.each(function() {
						var panel = $(this).datagrid("getPanel");
						var ck = panel.find(".datagrid-row[datagrid-row-index="
								+ index + "] .datagrid-cell-check")[0];
						$(ck).empty();
					});
		},
		disabledCheckbox : function(jq, index) {
			return jq.each(function() {
						var panel = $(this).datagrid("getPanel");
						panel.find(".datagrid-row[datagrid-row-index=" + index
			...
			return jq.each(function() {
						...
						if (fields && typeof fields == 'object' && fields.sort) {
							$.each(fields, function() {
										var field = this;
										bindEvent($('.datagrid-body td[field='
														+ field
														+ '] .datagrid-cell',
												panel));
									});
		...
		renderRow : function(_698, _699, _69a, _69b, _69c) {
			...
			for (var i = 0; i < _699.length; i++) {
				...
				if (col) {
					...
					cc.push(">");
					if (col.checkbox) {
						var type = opts.singleSelect == true
								? "radio"
								: "checkbox";
						cc.push("<input type=\"" + type + "\" name=\"" + _69e
								+ "\" value=\""
								+ (_69f != undefined ? _69f : "") + "\">");
					}  else {
						if (col.formatter) {
